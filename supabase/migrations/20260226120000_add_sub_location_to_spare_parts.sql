-- Migration: 20260226120000_add_sub_location_to_spare_parts.sql
-- Add sub_location column to spare_parts
ALTER TABLE public.spare_parts 
ADD COLUMN IF NOT EXISTS sub_location TEXT;

-- Update upsert_spare_part RPC to support p_sub_location
