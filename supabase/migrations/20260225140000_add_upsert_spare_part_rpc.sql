-- RPC function to upsert (create or update) a spare part, bypassing PostgREST column cache.
-- This runs with the security of the calling user via RLS.
