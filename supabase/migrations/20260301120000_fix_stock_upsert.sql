-- Migration: 20260301120000_fix_stock_upsert.sql
-- Description: Prevent upsert_spare_part from overriding current_stock during updates.
-- Only allows setting current_stock during initial INSERT.
...
BEGIN
    IF EXISTS (SELECT 1 FROM public.spare_parts WHERE id::TEXT = p_id) THEN
        ...
        UPDATE public.spare_parts SET
            ...
            -- current_stock     = p_current_stock, -- <--- REMOVED: Stock is now managed only by transactions
