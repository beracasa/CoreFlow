  ...
  const renderContent = () => {
    ...
    switch (view) {
      ...
      case AppView.CONFIGURATION: 
         ...
         return <Configuration machines={machines} technicians={technicians} onAddTechnician={handleAddTechnician} onAddMachine={handleAddMachine} onUpdateMachine={handleUpdateMachine} />;
